...
float teaport[3]={0,0,5};
void Draw_Scene()
{
    glPushMatrix();
    glTranslatef(teaport[0], teaport[1], teaport[2]);
...
void updateView(int width, int height)
{
    ...
    if (bPersp){
        ...
        gluPerspective(30.0, width/height, 0.1, 100);
    }
    else
...
void redraw()
{
    ...
    if (teaportRotate) teaportAngle +=0.5f;
